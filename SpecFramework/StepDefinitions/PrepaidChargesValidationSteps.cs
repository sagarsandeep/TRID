...
namespace TRID.StepDefinitions
{
    ...
    public class PrepaidChargesValidationSteps : TridTest
    {
        ...
        public void WhenUserEntersInputValueForFloodFee()
        {
            ...
            UIActions.GiveInput(PcFloodFee,TridVariable.FloodFee);
        }
        ...
        public void WhenUserEntersInputValueForLoanOriginationFee()
        {
            ...
            UIActions.GiveInput(PcLoanOriginationFee, TridVariable.LoanOriginationFee);
        }
        ...
        public void WhenUserEntersInputValueForPrepaidDailyInterest()
        {
            ...
            UIActions.GiveInput(PcPrepaidDailyInterest, TridVariable.PrepaidDailyInterest);
        }
        ...
        public void WhenUserEntersInputValueForTitle_ClosingFee()
        {
            ...
            UIActions.GiveInput(PcTitleClosingFee, TridVariable.TitleClosingFee);
        }
        ...
        public void WhenUserEntersInputValueForTitle_ClosingProtectionLetter()
        {
            ...
            UIActions.GiveInput(PcTitleClosingProtectionLetter, TridVariable.TitleClosingProtectionLetter);
        }

        [When(@"click on Prepaid Charges Test Button")]
        public void WhenClickOnPrepaidChargesTestButton()
        {
            UIActions.MoveToElement(PcPrepaidChargesText);
        ...
        {
            UIActions.Clear(PcCustomName);
            UIActions.GiveInput(PcCustomName, TridVariable.PrepaidCustomName);

            UIActions.Clear(PcCustomValue);
            UIActions.GiveInput(PcCustomValue, TridVariable.PrepaidCustomValue);
